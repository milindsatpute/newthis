...
import com.newthis.config.ApplicationProperties;
import com.newthis.config.DefaultProfileUtil;
...
@EnableZuulProxy
public class NewthisApp {

    private static final Logger log = LoggerFactory.getLogger(NewthisApp.class);

    private final Environment env;

    public NewthisApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(NewthisApp.class);
