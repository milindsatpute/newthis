...
describe('Department e2e test', () => {
    ...
    it('should load Departments', () => {
        ...
        expect(departmentComponentsPage.getTitle()).toMatch(/newthisApp.department.home.title/);
    ...
    it('should load create Department dialog', () => {
        ...
        expect(departmentDialogPage.getModalTitle()).toMatch(/newthisApp.department.home.createOrEditLabel/);
