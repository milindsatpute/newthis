...
describe('Country e2e test', () => {
    ...
    it('should load Countries', () => {
        ...
        expect(countryComponentsPage.getTitle()).toMatch(/newthisApp.country.home.title/);
    ...
    it('should load create Country dialog', () => {
        ...
        expect(countryDialogPage.getModalTitle()).toMatch(/newthisApp.country.home.createOrEditLabel/);
