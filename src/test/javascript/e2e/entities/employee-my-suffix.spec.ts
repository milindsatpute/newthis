...
describe('Employee e2e test', () => {
    ...
    it('should load Employees', () => {
        ...
        expect(employeeComponentsPage.getTitle()).toMatch(/newthisApp.employee.home.title/);
    ...
    it('should load create Employee dialog', () => {
        ...
        expect(employeeDialogPage.getModalTitle()).toMatch(/newthisApp.employee.home.createOrEditLabel/);
